function MyOrderList() {
  const orderList = [
    { date: '2022.05.19', company_name: '삼성전자', type: 'ask', volume: 100, price: 60000 },
    { date: '2022.05.19', company_name: '삼성전자', type: 'ask', volume: 100, price: 60000 },
    { date: '2022.05.19', company_name: '삼성전자', type: 'ask', volume: 100, price: 60000 },
    { date: '2022.05.19', company_name: '삼성전자', type: 'bid', volume: 100, price: 60000 },
    { date: '2022.05.19', company_name: '삼성전자', type: 'ask', volume: 100, price: 60000 },
    { date: '2022.05.19', company_name: '삼성전자', type: 'ask', volume: 100, price: 60000 },
    { date: '2022.05.19', company_name: '삼성전자', type: 'bid', volume: 100, price: 60000 },
  ];
      ...
      <div className="w-[90%] flex flex-col justify-center items-center overflow-scroll m-[20px]">
        <table className="w-full">
          <tr className="border-b border-[#e5e5e5]">
            <th className="text-left w-[18%] py-[10px] text-chart-font px-1">날짜</th>
            <th className="text-right w-[20%] py-[10px] text-chart-font">종목</th>
            <th className="text-right w-[17%] py-[10px] text-chart-font">거래유형</th>
            <th className="text-right w-[17%] py-[10px] text-chart-font">수량</th>
            <th className="text-right w-[25%] py-[10px] text-chart-font px-1">가격</th>
          </tr>
          {orderList.map((order) => (
            <tr
